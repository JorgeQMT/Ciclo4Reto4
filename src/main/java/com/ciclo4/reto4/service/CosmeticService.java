...
import com.ciclo4.reto4.repository.CosmeticRepository;
...
public class CosmeticService {
    ...
    public List<Cosmetic> productByPrice(double precio) {
        return cosmeticRepositorio.productByPrice(precio);
    }
    //Reto 5
    public List<Cosmetic> findByDescriptionLike(String description) {
        return cosmeticRepositorio.findByDescriptionLike(description);
    }
}
