...
import com.ciclo4.reto4.service.CosmeticService;
...
public class CosmeticController {
    ...
    public List<Cosmetic> productByPrice(@PathVariable("price") double precio) {
        return cosmeticService.productByPrice(precio);
    }

    //Reto 5
    @GetMapping("/description/{description}")
    public List<Cosmetic> findByDescriptionLike(@PathVariable("description") String description) {
        return cosmeticService.findByDescriptionLike(description);
    }
}
